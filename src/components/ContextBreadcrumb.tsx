...
import { HeaderBreadcrumbSlot } from "@/components/PageHeaderSlot";
...
function BreadcrumbSlotWithSeparator({ sep }: { sep: React.ReactNode }) {
  return (
    <span className="kc-breadcrumb-resource" style={{ display: "inline-flex", alignItems: "center", gap: 4, minWidth: 0 }}>
