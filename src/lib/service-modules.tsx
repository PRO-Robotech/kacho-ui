...
export const SERVICE_MODULES: ServiceModule[] = [
  {
    ...
    items: [
      ...
      { key: "route-tables", icon: <NodeIndexOutlined />, label: "Таблицы маршрутов", to: (f) => seg(f, "vpc/route-tables"), matches: (p) => projectRe("vpc/route-tables").test(p), requiresProject: true },
  ...
  // KAC-141 / KAC-171: NLB module — L4 Network Load Balancer.
  {
    ...
    stats: [
      { key: "load-balancers", label: "Балансировщиков", listPath: "/nlb/v1/networkLoadBalancers", payloadKey: "network_load_balancers" },
