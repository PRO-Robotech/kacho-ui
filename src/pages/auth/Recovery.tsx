  ...
  return (
    <AuthLayout>
      ...
      {step === "email" && (
        <>
          <Text type="secondary">
            Введите email — мы пришлём ссылку для восстановления доступа.
            Ссылка действительна {config.recoveryLinkTtlMin} минут.
          </Text>
          <Form
            form={form}
            layout="vertical"
        ...
        <Result
          ...
          subTitle={
            <Paragraph type="secondary">
              Мы отправили ссылку для восстановления. Откройте email и кликните по
              ссылке (действительна {config.recoveryLinkTtlMin} минут).
            </Paragraph>
          }
          extra={
            <Button
