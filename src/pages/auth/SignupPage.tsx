      ...
      >
        <Space direction="vertical" size="large" style={{ width: "100%" }}>
          ...
          <Alert
            ...
            description={
              <>
                При первом входе автоматически создаётся <b>Account</b> (ваш tenant) и
                стартовый <b>Project</b>. Вы становитесь <code>owner</code> и можете
                приглашать пользователей / создавать service-accounts / выдавать роли.
              </>
            }
          />
