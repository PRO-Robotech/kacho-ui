...
import { CopyableMonoId } from "@/components/iam/IamCommon";
...
export function AccessPage() {
  ...
  const users = useQuery({
    ...
    queryFn: () =>
      iamApi.listUsers({ pageSize: "1000", account_id: accountId }),
    enabled: !!accountId,
    staleTime: 30_000,
  });
        ...
        return (
          <Space size={6} direction="vertical" size-2>
            <Typography.Text strong>
              {u?.display_name || u?.email || row.userId}
            </Typography.Text>
            {u?.email ? (
            ...
            {u?.invite_status === "PENDING" ? (
              <Tag color="orange">приглашён</Tag>
            ) : null}
          </Space>
        );
      },
...
function InviteModal({
  ...
  return (
    <Modal
      ...
      onOk={magicLink ? () => { onClose(); setMagicLink(null); } : handleSubmit}
          ...
          <Alert
            ...
            description={
              <Space direction="vertical" style={{ width: "100%" }} size={4}>
                <Typography.Text>
                  Скопируйте magic-link и отправьте пользователю:
                </Typography.Text>
          ...
          <Tabs
            ...
            items={[
              ...
              },
              {
                ...
                children: cascaderOptions.custom.length === 0 ? (
                  <Typography.Text type="secondary">
                    У вашей организации пока нет своих ролей.
                  </Typography.Text>
                ) : (
                  <Cascader
